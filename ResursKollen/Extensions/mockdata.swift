...
extension MaterialEditSheet{
    ...
    static let premadeMaterialsMockData = [
        Material(title: "Kabelskor", priceOut: 2.50),
        Material(title: "Bräda", priceOut: 15.00),
        Material(title: "LED-list", priceOut: 7.25),
        Material(title: "Skruv", priceOut: 12.99),
        Material(title: "Kabel", priceOut: 3.75),
        Material(title: "Mutter", priceOut: 4.50),
        Material(title: "Silikon", priceOut: 6.00),
        Material(title: "Avkalkningsmedel", priceOut: 8.99),
        Material(title: "Hammare", priceOut: 2.20),
        Material(title: "Plåt", priceOut: 25.50),
        Material(title: "Kabelskor", priceOut: 2.50),
        Material(title: "Bräda", priceOut: 15.00),
        Material(title: "LED-list", priceOut: 7.25),
        Material(title: "Skruv", priceOut: 12.99),
